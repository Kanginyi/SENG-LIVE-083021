...
function createPokemon(event) {
  ...
  //Here, we're showing two different examples, but make sure to choose one and stick with it!
  ...
  const pokemon = {
    ...
    img: img,
    likes: 0,
    id: 6 //EVENTUALLY NEEDS TO CHANGE TO BE MORE DYNAMIC
  };
...
//This function is responsible any JS on a page land or refresh
//Put shit in here to clean up the code a lil bit
//Also to make sure that this code chunk runs AS SOON as someone pops in here
function init() {
...
//This is the above function being invoked/called
init();